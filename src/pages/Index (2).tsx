...
export default function Index() {
  ...
  const titles: Record<string, string> = {
    en: 'NoMark - TikTok Video Downloader No Watermark | Free HD',
    ar: 'NoMark - تحميل فيديوهات تيك توك بدون علامة مائية | HD مجاني',
    fr: 'NoMark - Télécharger TikTok Sans Filigrane | HD Gratuit',
    es: 'NoMark - Descargar TikTok Sin Marca de Agua | HD Gratis',
    tr: 'NoMark - TikTok Video İndirici Filigransız | Ücretsiz HD',
  };

  const descriptions: Record<string, string> = {
    en: 'Download TikTok videos without watermark in HD quality. Fast, free, no signup required.',
    ar: 'حمل فيديوهات تيك توك بدون علامة مائية بجودة HD. سريع ومجاني وبدون تسجيل.',
    fr: 'Téléchargez vidéos TikTok sans filigrane en HD. Gratuit et rapide.',
    es: 'Descarga vídeos de TikTok sin marca de agua en HD. Gratis y rápido.',
    tr: 'TikTok videolarını filigransız HD kalitede indir. Ücretsiz ve hızlı.',
  };
  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      <Helmet>
        ...
        <meta name="keywords" content="tiktok downloader, no watermark, تحميل تيك توك, تحميل فيديو بدون علامة مائية, free video downloader" />

        <link rel="canonical" href="https://nomarkdownloader.com/" />
        <meta property="og:title" content="NoMark - TikTok Video Downloader No Watermark" />
        <meta property="og:description" content="Download TikTok videos without watermark in HD quality." />
