...
const blogPosts =[
  { slug: "download-tiktok-without-watermark-2026-guide", titleKey: "blog.post4Title", excerptKey: "blog.post4Excerpt", date: "2026-03-28", readTime: "8 min", category: "TikTok" },
  { slug: "best-free-tiktok-downloader-no-signup", titleKey: "blog.post5Title", excerptKey: "blog.post5Excerpt", date: "2026-03-25", readTime: "7 min", category: "Guide" },
  { slug: "download-instagram-reels-without-watermark", titleKey: "blog.post6Title", excerptKey: "blog.post6Excerpt", date: "2026-03-20", readTime: "8 min", category: "Instagram" },
  { slug: "how-to-download-tiktok-videos-without-watermark", titleKey: "blog.post1Title", excerptKey: "blog.post1Excerpt", date: "2026-03-15", readTime: "5 min", category: "TikTok" },
  { slug: "best-instagram-reels-downloader-2026", titleKey: "blog.post2Title", excerptKey: "blog.post2Excerpt", date: "2026-03-10", readTime: "4 min", category: "Instagram" },
  { slug: "save-social-media-videos-hd-quality", titleKey: "blog.post3Title", excerptKey: "blog.post3Excerpt", date: "2026-03-05", readTime: "6 min", category: "Guide" },
  { slug: "how-to-save-tiktok-sounds-as-mp3", titleKey: "blog.post7Title", excerptKey: "blog.post7Excerpt", date: "2026-04-01", readTime: "5 min", category: "TikTok" },
  { slug: "tiktok-video-downloader-for-iphone-and-android", titleKey: "blog.post8Title", excerptKey: "blog.post8Excerpt", date: "2026-04-02", readTime: "6 min", category: "Guide" },
  { slug: "download-instagram-stories-without-login", titleKey: "blog.post9Title", excerptKey: "blog.post9Excerpt", date: "2026-04-03", readTime: "5 min", category: "Instagram" },
  { slug: "why-nomark-is-the-best-video-downloader", titleKey: "blog.post10Title", excerptKey: "blog.post10Excerpt", date: "2026-04-04", readTime: "7 min", category: "Guide" },
      ...
      <main className="pt-24 pb-16 px-4">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {blogPosts.map((post) => (
              <Link key={post.slug} to={`/blog/${post.slug}`} className="group relative rounded-2xl border border-border bg-card hover:border-primary/30 transition-all duration-300 overflow-hidden">
                <div className="aspect-video bg-gradient-to-br from-primary/20 to-[hsl(var(--chart-2))]/20 flex items-center justify-center">
                  <span className="text-xs font-bold uppercase tracking-wider text-primary/60 bg-primary/10 px-3 py-1 rounded-full">{post.category}</span>
                </div>
                <div className="p-5">
                  ...
                  <div className="flex items-center justify-between text-xs text-muted-foreground">
                    <div className="flex items-center gap-1.5"><Calendar className="h-3 w-3" /><span>{post.date}</span></div>
                    <span className="flex items-center gap-1 text-primary font-medium group-hover:gap-2 transition-all">{t('blog.readMore')} <ArrowRight className="h-3 w-3" /></span>
                  </div>
                </div>
              </Link>
            ))}
